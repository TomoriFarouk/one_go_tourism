...
class FourPeoplePage extends StatelessWidget {
  static const String id = 'Fourpeoplepage';
  const FourPeoplePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: const FourpeopleBookingScreen(),
    ));
  }
}

class FourpeopleBookingScreen extends StatefulWidget {
  const FourpeopleBookingScreen({Key? key}) : super(key: key);

  @override
  State<FourpeopleBookingScreen> createState() =>
      _FourpeopleBookingScreenState();
}

class _FourpeopleBookingScreenState extends State<FourpeopleBookingScreen> {
  File? image1, image2, image3, image4;
  final emailcontroller = TextEditingController();
  final addresscontroller = TextEditingController();
  TextStyle linkStyle = const TextStyle(color: Colors.blue);
  int currentStep = 0;
  String? phonenumber1, phonenumber2, phonenumber3, phonenumber4;
  int? radiochoice;
  var radiovalue;
  int? totalAmount;
  String? packageType;
  ...
  int? getTotalAmount() {
    radiochoice == 1 ? totalAmount = 9000000 : totalAmount = 17000000;
    return totalAmount;
  }

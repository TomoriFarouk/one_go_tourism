...
class TourDetailsCouple extends StatelessWidget {
  static const String id = 'TourdetailsCouplepage';

  const TourDetailsCouple({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const TourDetailsCouplePage();
  }
}

class TourDetailsCouplePage extends StatefulWidget {
  const TourDetailsCouplePage({Key? key}) : super(key: key);

  @override
  State<TourDetailsCouplePage> createState() => _TourDetailsCouplePageState();
}

class _TourDetailsCouplePageState extends State<TourDetailsCouplePage> {
  ...
  int? getTotalAmount() {
    radiochoice == 1 ? totalAmount = 5000000 : totalAmount = 10000000;
    return totalAmount;
  }

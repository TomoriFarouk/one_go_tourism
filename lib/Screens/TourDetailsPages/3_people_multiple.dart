...
class ThreePeoplePage extends StatelessWidget {
  static const String id = 'Threepeoplepage';
  const ThreePeoplePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: const ThreepeopleBookingScreen(),
    ));
  }
}

class ThreepeopleBookingScreen extends StatefulWidget {
  const ThreepeopleBookingScreen({Key? key}) : super(key: key);

  @override
  State<ThreepeopleBookingScreen> createState() =>
      _ThreepeopleBookingScreenState();
}

class _ThreepeopleBookingScreenState extends State<ThreepeopleBookingScreen> {
  ...
  int? getTotalAmount() {
    radiochoice == 1 ? totalAmount = 7000000 : totalAmount = 14000000;
    return totalAmount;
  }
